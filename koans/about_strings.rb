...
EOS
  ...
  def test_any_ruby_expression_may_be_interpolated
    ...
    sqrt5 = Math.sqrt 5
    expected = "The square root of 5 is " + sqrt5.to_s
  ...
  def test_you_can_get_a_single_character_from_a_string
    string = "Bacon, lettuce and tomato"
    assert_equal 'a'.bytes.to_a[0], string[1] # how to get single char code?
    assert_equal ?a, string[1] # aha, should have looked ahead to the next test
